...
db = MateirailsDatabase("test_fingerprints.db", [(MaterialsFingerprint, adapt_fingerprint), (DOSFingerprint, adapt_fingerprint), (BandStructureFingerprint, adapt_fingerprint), (Atoms, adapt_atom), (Cell, adapt_atom)], [("fingerprint", convert_fingerprint), ("atom", convert_atom), ("cell", convert_atom)])
...
testFingerPrintRet = db.selectCell("fingerprints", 'id', 1, "elecB")
print("Test")
print(testFingerPrintRet.fingerprint)
print("ELEC B")
