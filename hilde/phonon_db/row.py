...
class PhononRow(AtomsRow):
    ...
    def __init__(self, dct=None, phonon3=None, phonon=None):
        ...
        if dct:
            ...
            elif 'sc_matrix_2' in dct and isinstance(dct['sc_matrix_2'], list) and isinstance(dct['sc_matrix_2'][0], str):
            ...
            elif 'sc_matrix_3' in dct and isinstance(dct['sc_matrix_3'], list) and isinstance(dct['sc_matrix_3'][0], str):
    ...
    def to_phonon3(self, mesh=None):
        ...
        if mesh is None and "qmesh" in self and self.qmesh is not None:
            phonon3 = Phono3py(to_phonopy_atoms(pAtoms(ase_atoms=self.toatoms())),
