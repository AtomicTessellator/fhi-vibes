...
def setup_atoms_task(task_spec, atoms, calc, fw_settings):
    ...
    Parameters:
        ...
        atoms (dict): Dictionary representation of the ase.atoms.Atoms
...
def generate_task(task_spec, fw_settings, atoms, calc):
    ...
    Returns:
        (PyTask): Task for the given TaskSpec
    """
...
def generate_update_calc_task(calc_spec, updated_settings):
    ...
    Returns:
        (PyTask): Task to update the calculator in the Fireworks database
    """
    return PyTask(
        {
