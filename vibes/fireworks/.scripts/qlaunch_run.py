...
from vibes.fireworks.queue_launcher import rapidfire
from vibes.fireworks.launchpad import LaunchPad as LaunchPad
from vibes.fireworks.combined_launcher import fw_defaults
...
def qlaunch():
    """Defines the command qlaunch_vibes"""
    m_description = (
